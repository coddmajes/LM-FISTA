...
class GLISTA_en_de(tf.Module):
    def __init__(self, _layers, _A, _unshared, _nums, _ss, _percent, _max_percent, _uf,
                 ...
                 _lam=1., soft=None):
        super(GLISTA_en_de, self).__init__()
        """
            _layers: int
            _A: matrix
        ...
        self.uf = _uf  # str
        self.alti = _alti
        self.is_overshoot = _overshoot
        self.is_gain = _gain  # bool
        self.gain_fun = _gain_fun  # str
        self.over_fun = _over_fun
        self.is_both_gate = _both_gate  # bool
        ...
        if self.uf == 'combine' and self.is_gain:
